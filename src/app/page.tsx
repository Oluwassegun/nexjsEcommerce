     ...
     {isFeaturedGame &&(
       <>
        ...
        <section className={sectionClassNames.featured}>
          <div className={sectionClassNames.featuredContent}>
            ...
            <p className={featuredClassNames.gameDetails}>{isFeaturedGame.description}</p>
      ...
      <section
        ...
        <div className={styles.categoryContent}>
          <h2 className={styles.categoryHeading}>Catergories</h2>
          <p className={styles.categorySubHeading}>Explore a wide range of games, offering thrilling adventures,
            ...
            keep you entertained for hours.</p>
      ...
      <section id='recentgames' className={recentGamesClasses.section}>
